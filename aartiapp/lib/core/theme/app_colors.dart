...
class AppColors {
  ...
  static const saffronDark = Color(
    0xFFC46A00,
  ); // Accessible saffron for text on light
  ...
  static const ink3 = Color(
    0xFF8C8880,
  ); // Temple Stone secondary — captions, metadata
  ...
  // Feedback surfaces
  static const snackBarSuccess = Color(0xFF476A52); // Affirming success fill
  static const snackBarError = Color(0xFF8E3E35); // Error and failure feedback
  static const snackBarWarning = Color(
    0xFF9A6116,
  ); // Caution and destructive acknowledgement
  static const snackBarInfo = Color(
    0xFF3F5F78,
